...
/**
 * Provides the local service interface for MyArticle. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sasha
 * @see MyArticleLocalServiceUtil
...
public interface MyArticleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MyArticleLocalServiceUtil} to access the my article local service. Add custom service methods to {@link com.softwerke.srv.service.impl.MyArticleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
