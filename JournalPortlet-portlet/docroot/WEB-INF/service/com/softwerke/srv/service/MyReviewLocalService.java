...
/**
 * Provides the local service interface for MyReview. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sasha
 * @see MyReviewLocalServiceUtil
...
public interface MyReviewLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MyReviewLocalServiceUtil} to access the my review local service. Add custom service methods to {@link com.softwerke.srv.service.impl.MyReviewLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
